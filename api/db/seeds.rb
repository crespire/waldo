...
track.secrets.build(name: 'wilma', coords: [755, 1385]).save
track.secrets.build(name: 'wizard', coords: [1840, 1640]).save
track.secrets.build(name: 'odlaw', coords: [1800, 1230]).save

beach = Picture.create(name: 'beach', difficulty: 'medium')
beach.secrets.build(name: 'odlaw', coords: [323, 695]).save
