  ...
  return(
    <div className="flex grow justify-around content-center items-center">
      <span className="text-center">
        ...
        (<Link className="underline hover:ring underline hover:ring-slate-300" to="leaderboards/track">Top scores</Link>)
      </span>
      <span className="text-center">
        <Link to="game/beach"><img className="max-w-xs" src={thumbnailBeach} alt="Beach"></img></Link>Medium&nbsp;
        (<Link className="underline hover:ring underline hover:ring-slate-300" to="leaderboards/beach">Top scores</Link>)
      </span>
      <span className="text-center">
        <Link to="game/fruit"><img className="max-w-xs" src={thumbnailFruit} alt="Fruitland"></img></Link>Hard&nbsp;
        (<Link className="underline hover:ring underline hover:ring-slate-300" to="leaderboards/fruit">Top scores</Link>)
      </span>
    </div>
  );
}
